...
const ImageModal: React.FC<Props> = ({ imageUrl, setIsMoadlOpen, image_name }) => {
  ...
  return (
    <motion.div
      ...
      dragElastic={0.2}
      className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-200 border border-gray-300 shadow-lg z-50 rounded-lg p-4 cursor-move max-w-[58vw] max-h-[90vh] overflow-auto"
      style={{
